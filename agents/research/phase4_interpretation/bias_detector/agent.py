...
Detects potential biases in research methodology, data, and interpretations
"""
...
class BiasDetectorAgent(BaseResearchAgent):
    """Agent for bias detector."""
    ...
    def get_system_prompt(self) -> str:
        return """You are a Bias Detector AI agent that identifies potential biases in research.
...
bias_detector_001_agent = BiasDetectorAgent()
