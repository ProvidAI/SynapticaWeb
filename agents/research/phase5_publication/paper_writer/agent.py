...
Writes research papers in academic format with proper structure and citations
"""
...
class PaperWriterAgent(BaseResearchAgent):
    """Agent for research paper writer."""
    ...
    def get_system_prompt(self) -> str:
        return """You are a Research Paper Writer AI agent that creates academic papers.
...
paper_writer_001_agent = PaperWriterAgent()
