...
Updates agent reputations based on research quality and contribution
"""
...
class ReputationManagerAgent(BaseResearchAgent):
    """Agent for reputation manager."""
    ...
    def get_system_prompt(self) -> str:
        return """You are a Reputation Manager AI agent that maintains agent reputation scores.
...
reputation_manager_001_agent = ReputationManagerAgent()
