...
Designs testable hypotheses and experiment protocols based on literature synthesis
"""
...
class HypothesisDesignerAgent(BaseResearchAgent):
    """Agent for hypothesis designer."""
...
hypothesis_designer_001_agent = HypothesisDesignerAgent()
