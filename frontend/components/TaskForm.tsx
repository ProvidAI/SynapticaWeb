    ...
    <Card className="relative overflow-hidden rounded-3xl border border-white/40 bg-white/95 shadow-[0_30px_80px_-45px_rgba(59,130,246,0.5)] transition">
      ...
      <CardHeader className="relative z-10 space-y-4 pb-0">
        ...
        <div className="space-y-2">
          <CardTitle className="text-3xl font-semibold text-slate-900">Start new research</CardTitle>
          <CardDescription className="text-base leading-relaxed text-slate-500">
            Describe your research question and data needs. ProvidAI will match you with specialist agents and draft a research plan.
          </CardDescription>
        </div>
      </CardHeader>
      <CardContent className="relative z-10 space-y-6 pt-6">
        <div className="space-y-3">
          ...
          <Textarea
            id="description"
            placeholder="Example: Analyze cryptocurrency market trends for Q4 2024, collect price data from major exchanges, and generate a trend forecast report."
            value={description}
          ...
          <p className="text-xs text-slate-400">
            Tip: specify data sources, analysis methods, and desired output format so agents can provide accurate cost estimates.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-t border-slate-200/60 pt-4 text-xs text-slate-400">
          <span>ProvidAI will draft a research plan and match you with specialist agents before you approve.</span>
          <Button
