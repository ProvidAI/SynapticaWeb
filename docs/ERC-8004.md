...
tags:
  - "clippings"
---
⚠️ Review [Standards Track: ERC](https://eips.ethereum.org/erc)

### Discover agents and establish trust through reputation and validation

| Authors | Marco De Rossi ([@MarcoMetaMask](https://github.com/MarcoMetaMask)), Davide Crapis (@dcrapis) < [davide@ethereum.org](https://eips.ethereum.org/EIPS/) >, Jordan Ellis < [jordanellis@google.com](https://eips.ethereum.org/EIPS/) >, Erik Reppel < [erik.reppel@coinbase.com](https://eips.ethereum.org/EIPS/) > |
| --- | --- |
| Created | 2025-08-13 |
...
Marco De Rossi ([@MarcoMetaMask](https://github.com/MarcoMetaMask)), Davide Crapis (@dcrapis) < [davide@ethereum.org](https://eips.ethereum.org/EIPS/) >, Jordan Ellis < [jordanellis@google.com](https://eips.ethereum.org/EIPS/) >, Erik Reppel < [erik.reppel@coinbase.com](https://eips.ethereum.org/EIPS/) >, "ERC-8004: Trustless Agents \[DRAFT\]," *Ethereum Improvement Proposals*, no. 8004, August 2025. \[Online serial\]. Available: https://eips.ethereum.org/EIPS/eip-8004.